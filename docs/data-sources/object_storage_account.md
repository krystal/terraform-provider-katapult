...
[`katapult_object_storage_account.<name>.region`](../resources/object_storage_account.md)
...
- `region` (String) Object storage region. Currently the only available region is `uk-lon-1`.
